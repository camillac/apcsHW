...
public class LinkedList implements List_more {
	...
	private Node nodeAtIndex( int index ) {
		Node nodeAtIndex = nodeBeforeIndex( index ).next;
		if (nodeAtIndex == null)
			throw new IndexOutOfBoundsException("Not Valid Index");
		else
			return nodeAtIndex;
	...
	public void add( int index, String newValue) {
		...
		if (index == 0){
		    ...
		    Node beforeIndex = nodeBeforeIndex( index );
		    nodeToAdd.next = beforeIndex.next;
	...
	public Node remove( int index ) {
		...
		// }
		   ...
		   Node beforeIndex = nodeBeforeIndex(index);
		   nodeToRemove.cargo = beforeIndex.next.cargo;
    ...
    public String get( int index){
		...
		return nodeAtIndex( index ).cargo;
    }
    ...
    public String set( int index, String newValue) {
        ...
        String cargoAtIndex = nodeAtIndex(index).cargo;
		
        String oldCargo = cargoAtIndex;
        cargoAtIndex = newValue;
        return oldCargo;
    }
