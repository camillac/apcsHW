...
public class UserOfLinkedList {
    public static void main(String[] commandLine) {
        ...
        // test removing interior element
        System.out.println( "test removing interior element");
        System.out.println( fruits.remove( 1) + " expecting persimmon");
        System.out.println("expecting crabapple,PEPPER: "
			   + fruits);
        System.out.println();

	// test removing last element
        System.out.println( "test removing last element");
        System.out.println( fruits.remove( fruits.size() - 1) + " expecting PEPPER");
        System.out.println("expecting crabapple: "
			   + fruits);
        System.out.println();
