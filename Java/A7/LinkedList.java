...
public class LinkedList implements List_more {
    ...
    private Node nextNode;  /* during iteration, holds a reference to a node
                               whose cargo the user has not yet been given,
    ...
    /**
      For iteration,
      initialize this implementation so that a succeeding call to
      nextElement() returns the first element in the list.
     */
