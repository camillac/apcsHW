...
public class UserOfBoard {
    ...
    public static void main(String[] commandLine) {
        ...
        System.out.println( "Test the copy constructor: can we change the original "
                          + "without messing with the copy?");
        BoardForNQueens copy = new BoardForNQueens( b);
        System.out.println( "before change, the original is..." 
                          + System.lineSeparator()
                          + b
                          );
        System.out.println( "before change, the copy is..."
                          + System.lineSeparator()
                          + copy
                          );
        b.populate( 2);  // change the original
        System.out.println( "after change, the original is..." 
                          + System.lineSeparator()
                          + b
                          );
        System.out.println( "after change, the copy is..."
                          + System.lineSeparator()
                          + copy
                          + System.lineSeparator());
    }
